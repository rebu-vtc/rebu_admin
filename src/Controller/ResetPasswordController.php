...
class ResetPasswordController extends AbstractController
{
    ...
    public function request(Request $request, MailerInterface $mailer): Response
    {
        ...
        return $this->render('rebu/reset_password/request.html.twig', [
    ...
    public function checkEmail(): Response
    {
        ...
        return $this->render('rebu/reset_password/check_email.html.twig', [
    ...
    public function reset(
        ...
        return $this->render('rebu/reset_password/reset.html.twig', [
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ...
            ->htmlTemplate('rebu/reset_password/email.html.twig')
            ->context([
                'resetToken' => $resetToken,
            ])
            ;
